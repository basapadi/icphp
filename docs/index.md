...
- WKHTMLTOPDF https://wkhtmltopdf.org/downloads.html or install in ubuntu with sudo apt-get install wkhtmltopdf. For Archlinux just install the package in this repository named wkhtmltox-0.12.6-3.archlinux-x86_64.pkg.tar.xz.
