...
trait StaticResponse {
     ...
     * @return array
     */
    public static function fakeResponse($status = true, $message = 'Fake Response', $data = null) {
     ...
     * @return array
     */
    public static function response301(string $appendText = '', string $appendTextDir = '') {
    ...
    public static function response200(string $appendText = '',$data = null, $appendData = null){
     ...
     * @return array
     */
    public static function response400(string $appendText = '', string $appendTextDir = '', $appendData = null) {
        ApiResponse::setStatusCode(400, false);
        ApiResponse::setAppendMessage($appendText);
        if (!empty($appendTextDir)) {
            ApiResponse::setAppendMessageDir($appendTextDir);
        }
        return ApiResponse::make(false, '', $appendData);
    }
     ...
     * @return array
     */
    public static function response404(string $appendText = '', string $appendTextDir = '') {
     ...
     * @return array
     */
    public static function response405(string $appendText = '', string $appendTextDir = '') {
     ...
     * @return array
     */
    public static function response500(string $appendText = '', $data = []) {
