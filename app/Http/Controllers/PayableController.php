...
class PayableController extends BaseController
{
    public function __construct(){
        ...
        $this->setColumns([
            ...
            ['value' => 'terbayar_formatted', 'label'=> 'Total Terbayar', 'align' => 'right','class' => 'font-mono'],
        ...
        $this->setDetailSchema([
            'main' => [
                ...
                'title' => 'Transaksi',
                'fields' => [
                    'contact__nama' => ['label' => 'Nama Pemasok'],
                    ...
                    'terbayar_formatted' => ['label' => 'Total Terbayar','class' => 'font-mono'],
            ...
            'details' => [
                ...
                'fields' => [
                    ...
                    'tanggal_terima_formatted' => ['label' => 'Tanggal Terima'],
