...
# build directory.
TK_BUILD_LIB_SPEC='-L/private/tmp/_py/_bld/tk8.6.12/unix -ltk8.6'
...
# compiled.
TK_SRC_DIR='/private/tmp/_py/_bld/tk8.6.12'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/private/tmp/_py/_bld/tk8.6.12/unix -ltkstub8.6'
...
TK_BUILD_STUB_LIB_PATH='/private/tmp/_py/_bld/tk8.6.12/unix/libtkstub8.6.a'
