<template>
  <div class="relative min-h-screen flex flex-col justify-center py-2 sm:px-6 lg:px-8 bg-gradient-to-t from-orange-200 to-white">
  <!-- GRID -->
    <div class="absolute inset-0 z-0 bg-[length:20px_20px]
        [background-image:linear-gradient(to_right,rgba(253,219,164,0.5)_1px,transparent_1px),linear-gradient(to_bottom,rgba(253,219,164,0.5)_1px,transparent_1px)]
        pointer-events-none">
    </div>
