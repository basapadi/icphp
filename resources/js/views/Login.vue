<template>
  <div class="relative h-screen flex flex-col justify-center py-2 sm:px-6 lg:px-8 bg-gradient-to-t from-gray-200 to-white">
    ...
    <div class="sm:mx-auto sm:w-full z-2 sm:max-w-md">
    ...
    <div v-if="!initial" class="my-2 sm:mx-auto z-2 sm:w-full sm:max-w-md">
    ...
    <div v-else class="mt-2 sm:mx-auto z-2 sm:w-full sm:max-w-md">
