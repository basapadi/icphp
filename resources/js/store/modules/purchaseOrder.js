...
const actions = {
    async grid({ commit, rootState }, payload) { 
        try {
            const resp = await axios.get('/api/purchase/order/grid', {
                params: payload,
    ...
    async form({ commit, rootState }, payload) { 
        try {
            const resp = await axios.get('/api/purchase/order/form', {
                params: payload,
                paramsSerializer: params => {
                    return qs.stringify(params, { arrayFormat: 'repeat' })
                }
    ...
    async delete({ commit, rootState }, id) {
        try {
            const resp = await axios.delete('/api/purchase/order/'+id);
            return resp
        } catch (err) {
            throw err
        }
