...
const actions = {
    async grid({ commit, rootState }, payload) { 
        try {
            const resp = await axios.get('/api/user/grid', {
                params: payload,
    ...
    async form({ commit, rootState }, payload) { 
        try {
            const resp = await axios.get('/api/user/form', {
                params: payload,
                paramsSerializer: params => {
                    return qs.stringify(params, { arrayFormat: 'repeat' })
                }
    ...
    async create({ commit, rootState }, payload) { 
          try {
              const resp = await axios.post('/api/user',payload);
              return resp
          } catch (err) {
              throw err
          }
    ...
    async edit({ commit, rootState }, id) {
        try {
            const resp = await axios.get('/api/user/edit/'+ id);
            return resp
        } catch (err) {
            throw err
        }
