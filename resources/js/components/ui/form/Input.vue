        ...
        <div class="flex flex-col gap-1.5 w-full">
            ...
            >
                ...
                <div v-if="hint" class="relative group">
                    ...
                    <div
                        style="z-index: 9999"
                        class="absolute left-full ml-2 top-1/2 -translate-y-1/2 w-60 p-2 text-xs bg-primary text-primary-foreground border rounded-md shadow-md opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none"
                    >
                        {{ hint }}
                    </div>
                </div>
