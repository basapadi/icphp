...
export default {
    ...
    components: { Label },
    props: {
        defaultValue: { type: String, default: "" }, // format: HH:mm
        modelValue: { type: String, default: "" },   // format: HH:mm
        ...
        minTime: { type: String, default: "" }, // HH:mm
        maxTime: { type: String, default: "" }, // HH:mm
    },
