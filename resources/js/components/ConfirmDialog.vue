<template>
    ...
    >
        <Card
            class="w-full max-w-2xl bg-card shadow-lg rounded-lg overflow-hidden pt-0"
            @click.stop
        >
            <CardContent class="p-4">
                ...
                >
                    <div class="border-b mb-2">
                        <h2
                            v-if="contextMenu.title"
                            class="text-xl font-bold mb-2 text-muted-foreground text-center"
                        >
                            {{ contextMenu.title }}
                        </h2>
                    </div>
                    ...
                    <div class="max-h-[70vh] overflow-y-auto space-y-4">
                        <div
                            ...
                            v-for="(field, x) in contextMenu.forms"
                            :key="x"
                        >
                            <Input
