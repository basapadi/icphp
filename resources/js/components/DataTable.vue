                ...
                >
                            ...
                            >
                                <template v-if="column.show">
                                    <template v-if="column.name == 'actions'">
                                        <th
                                            class="px-4 py-2 text-left font-bold text-xs text-gray-500 uppercase tracking-wider border-2 border-gray-200"
                                            style="width: 50px"
                                        >
                                            {{ column.label }}
                                        </th>
                                    ...
                                    <template v-else>
                                        <th
                                            :class="`px-4 py-2 text-left font-bold text-xs text-gray-500 uppercase tracking-wider border-2 border-gray-200 text-${column.align}`"
                                            :style="`${column.styles}`"
                                        >
                                            {{ column.label }}
                                        </th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        >
                            <template v-if="properties.multipleSelect">
                                <td
                                    class="px-4 whitespace-nowrap border-2 border-gray-200"
                                    style="width: 10px"
                                >
                                    <input
                            ...
                            >
                                ...
                                >
                                    ...
                                    <template v-if="column.name == 'actions'">
                                        <div
                                            class="flex items-beetwen space-x-2"
                                        >
                                            <template
                                                v-if="
                                    ...
                                    <template v-else>
                                        <span
                                            :class="`text-sm text-gray-600 ${column.class}`"
                                            :style="`${column.styles}`"
                                            >{{
                                                $helpers.getSubObjectValue(
                                                    data,
            ...
            <div class="px-4 py-3 border-t border-gray-200 bg-gray-50">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <button
                            class="px-3 py-1 text-sm bg-orange-100 border-1 text-orange-500 rounded-md hover:bg-orange-200 transition-colors"
                        >
                            {{ pagination._page }}
                        </button>
                        <button
...
export default {
    ...
    methods: {
        ...
        nextPage() {
            if (this.pagination._page < this.totalPages)
