        ...
        <div class="flex flex-1 overflow-hidden pt-10">
            ...
            >
                ...
                <nav class="p-2">
                    <div
                        v-if="!isCollapsed"
                        class="pl-2 mt-2 pr-2 sticky top-0 z-10"
                    >
                        <div class="relative">
                            <Search
                            ...
                            <input
                                ...
                                class="pl-7 h-7 text-xs text-muted-foreground bg-card border border-border rounded w-full px-2"
                            />
                        </div>
                    </div>
